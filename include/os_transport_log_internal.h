...
static inline void ost_log_init_locked(OstLogState *state)
{
...
static inline void ost_log_emit_locked(OstLogState *state, LogLevel level, const char *formatted_line)
{
...
static inline void ost_log_vwrite(LogLevel level, const char *file, int line, const char *fmt, va_list args)
{
    char msg_buf[1024];
    char line_buf[1408];
...
static inline void ost_log_write(LogLevel level, const char *file, int line, const char *fmt, ...)
{
    va_list args;
...
#ifdef OST_LOG_ENABLE_TEST_HOOKS
static inline void ost_log_reset_for_tests(void)
{
    OstLogState *state = ost_log_state();
...
static inline void ost_log_force_syslog_available_for_tests(bool available)
{
